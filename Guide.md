...
```
In order for a Twig Rod to have `rarity = 10`, `diceRoll` must be less than 0.000050119. But for a Gold Rod to have `rarity = 10`, `diceRoll` must less than 0.0002213. 
